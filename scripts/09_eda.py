...
Salidas:
  - resultados/figuras/   → gráficos en PNG
  - resultados/tablas/    → tablas resumen en CSV
  - resultados/reportes/  → reporte de EDA en MD
"""
...
print(f"\n{'='*65}")
print("  EDA COMPLETO — todas las figuras en resultados/figuras/")
print(f"{'='*65}")
