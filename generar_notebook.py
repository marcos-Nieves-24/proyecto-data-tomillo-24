...
2. **Local** — busca en `resultados/tablas/` relativo al directorio de trabajo
""")
...
# ===== FINAL: SAVE =====
nb.cells = cells
OUTPUT = '/home/mniev/projects/proyecto_tomillo/analisis_tomillo_fusarium.ipynb'
